...
\section{Observation}
The implementation of multiplication looks remarkably like it's the [Cayley-Dickson](https://en.wikipedia.org/wiki/Cayley–Dickson_construction) construction.
